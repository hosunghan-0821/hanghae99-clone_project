package com.hanghae.clone_project.security.handler;
...
import com.hanghae.clone_project.security.jwt.JwtTokenUtils;
...
//        final String refreshTokenStr = JwtTokenUtils.generateJwtRefreshToken();
        ...
        // json 형태로 바꾸기
        String result = mapper.writeValueAsString(ResponseDto.success(loginInfoDto));
